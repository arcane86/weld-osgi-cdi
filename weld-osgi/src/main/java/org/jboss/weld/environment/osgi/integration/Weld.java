...
import org.osgi.cdi.api.extension.annotation.SentAnnotation;
import org.osgi.cdi.api.extension.annotation.SpecificationAnnotation;
...
import org.osgi.cdi.api.integration.BundleHolder;
import org.osgi.cdi.api.integration.ContainerObserver;
import org.osgi.cdi.api.integration.RegistrationsHolder;
 ...
 */
public class Weld implements BundleContainer {
    ...
    public void fire(InterBundleEvent event) {
        getEvent().select(InterBundleEvent.class,
